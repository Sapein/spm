...
/* #define DOUBLE_FORK false /1* true = Double-Fork to Daemonize ; false = Do not double-fork *1/ */
/* #define NAMED_PROCS false /1* true = Named Processes at runtime ; false = Processes don't have names at runtime *1/ */
